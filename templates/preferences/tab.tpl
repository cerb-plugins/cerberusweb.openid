...
<ul style="margin:5px 0px 0px 10px;padding:0px;list-style:none;">
	...
	<li style="padding-bottom:10px;">
		...
		<button type="button" onclick="if(confirm('Are you sure you want to delete this OpenID identity?')) { $(this).closest('li').remove(); genericAjaxGet('','c=openid.ajax&a=deletePref&id={$openid_id}'); }"><span class="cerb-sprite2 sprite-minus-circle"></span></button>
